...
And obtain a mean of `r sprintf("%.0f", round(steps.per.day.mean))` and a median
of `r sprintf("%.0f", round(steps.per.day.median))`.
...
`r sprintf("%.0f", round(imputed.steps.per.day.mean))` and
`r sprintf("%.0f", round(imputed.steps.per.day.median))`, respectively. We can
compare them to the previous values of the mean
(`r sprintf("%.0f", round(steps.per.day.mean))`) and the median
(`r sprintf("%.0f", round(steps.per.day.median))`). The new mean and median are
